...
KadabraEvosMoves:
; Evolutions
	db EVOLVE_LEVEL, 36, ALAKAZAM ; VPH feature: removing trade evolutions
	db 0
; Learnset
	db 16, CONFUSION
	db 20, DISABLE
...
GravelerEvosMoves:
; Evolutions
	db EVOLVE_LEVEL, 36, GOLEM ; VPH feature: removing trade evolutions
	db 0
; Learnset
	db 11, DEFENSE_CURL
	db 16, ROCK_THROW
...
MachokeEvosMoves:
; Evolutions
	db EVOLVE_LEVEL, 36, MACHAMP ; VPH feature: removing trade evolutions
	db 0
; Learnset
	db 20, LOW_KICK
	db 25, LEER
...
HaunterEvosMoves:
; Evolutions
	db EVOLVE_LEVEL, 36, GENGAR ; VPH feature: removing trade evolutions
	db 0
; Learnset
	db 29, HYPNOSIS
	db 38, DREAM_EATER
