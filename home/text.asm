...
TMCharText::      db "ilo sike sona@" ; "TM"
TrainerCharText:: db "jan pi lawa monsuta@" ; "TRAINER"
PCCharText::      db "ilo nanpa@" ; "PC"
RocketCharText::  db "[lawa open ken.tomo.]@" ; "ROCKET"
PlacePOKeText::   db "poki@" ; "POKé"
SixDotsCharText:: db "……@"
EnemyText::       db "ante  @" ; "Enemy "
